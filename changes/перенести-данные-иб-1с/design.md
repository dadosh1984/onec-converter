...
- `changes/перенести-данные-иб-1с/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for перенести-данные-иб-1с
