# Дизайн — поддержку-документов-табличных-частей
...
- `changes/поддержку-документов-табличных-частей/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for поддержку-документов-табличных-частей
