// GREEN: cache — кеш метаданных/данных (ключ путь+размер+mtime+хэш, инвалидация, хранилище)
import * as fs from 'node:fs';
import * as path from 'node:path';

export function assumption_cache_mtime() {
  const files: Record<string, string> = {
    'src/onec_converter/cache.py': `"""Кеш результатов анализа ИБ.
...
`,
    'tests/test_cache.py': `"""Unit-тесты кеша."""
from pathlib import Path
