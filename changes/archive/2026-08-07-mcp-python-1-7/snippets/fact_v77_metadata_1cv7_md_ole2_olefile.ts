// GREEN: v77_metadata — парсер 1Cv7.MD (OLE2, olefile): дерево объектов/реквизитов/типов
import * as fs from 'node:fs';
import * as path from 'node:path';

export function fact_v77_metadata_1cv7_md_ole2_olefile() {
  const files: Record<string, string> = {
    'src/onec_converter/v77_metadata.py': `"""Парсер метаданных ИБ 1С 7.7 (1Cv7.MD, OLE2-контейнер).
...
`,
    'tests/test_v77_metadata.py': `"""Unit-тесты v77_metadata (на моке olefile) + интеграция на реальной базе."""
from pathlib import Path
