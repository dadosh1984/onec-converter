# Дизайн — clean-up-onec-converter
...
- `changes/clean-up-onec-converter/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for clean-up-onec-converter
