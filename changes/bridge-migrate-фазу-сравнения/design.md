# Дизайн — bridge-migrate-фазу-сравнения
...
- `changes/bridge-migrate-фазу-сравнения/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for bridge-migrate-фазу-сравнения
