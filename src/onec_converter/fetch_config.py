"""fetch-config: релиз конфигурации как ИСТОЧНИК метаданных .
...
_META_TAGS = frozenset({
    ...
    'МодульСеанса', 'ОбщаяФорма', 'ГруппаКоманд', 'Команда', 'Подсистема',
    'ЭлементСтиля', 'КритерийОтбора', 'ОбщийМакет', 'ОпределяемыйТип',
