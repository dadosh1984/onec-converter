"""Анонимизатор персональных данных (PII) — (модернизация).
...
# Профили анонимизации 152-ФЗ (): типовые поля по сферам применения.
...
PII_PROFILES: dict[str, list[str]] = {
    ...
    'uzbekistan': ['ФИО', 'Фамилия', 'Имя', 'Отчество', 'Телефон',
                   'МобильныйТелефон', 'ПИНФЛ', 'ИНН', 'Паспорт', 'Адрес'],
}
