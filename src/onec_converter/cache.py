...
@dataclass
class Cache:
    """Простейшее файловое хранилище кеша: ключ -> каталог с именованными
    артефактами. Потокобезопасен (RLock вокруг каждого файлового доступа,
    Фаза 47): конкурентные чтения/записи из разных потоков не портят
    артефакты."""
