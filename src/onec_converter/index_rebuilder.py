"""Восстановление индексов после прямой записи .
...
def build_repair_script(target_dir: str | Path,
    ...
    if tool_lower == '1cv8':
        ...
        script = [
            '@echo off',
            'rem Восстановление индексов и тест целостности ИБ-приёмника ()',
            f'set TARGET={cd}',
            f'{cmd}',
        ...
        script = [
            '#!/bin/sh',
            '# Восстановление индексов ИБ-приёмника через chdbfl ()',
